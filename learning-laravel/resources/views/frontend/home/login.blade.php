...
<div class="login">
    ...
    <form method="POST" class="form" role="form">
        @csrf
        <input type="email" id="exampleInputEmail1" name="email" placeholder="Email" required="required" />
        <input type="password" id="exampleInputPassword1" name="password" placeholder="Password" required="required" />
